...
function updateTheme() {
    ...
    if (state.globalSettings.theme === 'christmas') {
        elements.themeContainer.innerHTML = `
        ...
        `;
    } else if (state.globalSettings.theme === 'summer') {
        elements.themeContainer.innerHTML = `
        <style>
            .ocean {
                height: 100px;
        ...
        `;
    } else if (state.globalSettings.theme === 'halloween') {
        elements.themeContainer.innerHTML = `
        <div class="snowflakescript">
            <style>
                .snowflake {
        ...
        `;
    } else if (state.globalSettings.theme === 'valentine') {
        elements.themeContainer.innerHTML = `
        <style>
            @keyframes float {
        ...
        `).join('')}
        `;
    } else if (state.globalSettings.theme === 'easter') {
        elements.themeContainer.innerHTML = `
        <style>
            @keyframes bounce {
